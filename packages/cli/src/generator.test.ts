import { parseSQLFile, TSQueryAST } from '@pgtyped-curly/parser';
import { IQueryTypes } from '@pgtyped-curly/query/lib/actions.js';
import { ParameterTransform } from '@pgtyped-curly/runtime';
...
describe('query-to-interface translation', () => {
  [ProcessingMode.SQL, ProcessingMode.TS].forEach((mode) => {
    ...
    `;
      ...
      // Test out imports
      types.use(
        { name: 'PreparedQuery', from: '@pgtyped-curly/runtime' },
        TypeScope.Return,
      );
      ...
      const expectedTypes = `import { PreparedQuery } from '@pgtyped-curly/runtime';
